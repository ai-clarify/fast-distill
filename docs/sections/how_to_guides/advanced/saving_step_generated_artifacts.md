...
??? "Example full code"
    ...
    if __name__ == "__main__":
        ...
        distiset.push_to_hub("fastdistill-internal-testing/fastdistill-artifacts-example")
    ```

The generated [fastdistill-internal-testing/fastdistill-artifacts-example](https://huggingface.co/datasets/fastdistill-internal-testing/fastdistill-artifacts-example) dataset repository has a section in its card [describing the artifacts generated by the pipeline](https://huggingface.co/datasets/fastdistill-internal-testing/fastdistill-artifacts-example#artifacts) and the generated plot can be seen [here](https://huggingface.co/datasets/fastdistill-internal-testing/fastdistill-artifacts-example/blob/main/artifacts/count_text_characters_0/text_character_count_distribution/figure.png).
