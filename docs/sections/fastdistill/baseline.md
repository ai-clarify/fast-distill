...
### Student eval (MLX, WikiSQL eval split)
...
From `~/.cache/fastdistill/artifacts/openrouter_wikisql_1k_teacher_2026-01-26_v2/reports/student_eval_pre_eval/quality_report.json`:
- total: 1000
- exec_pass_rate: 0.53
- gold_match_rate: 0.0
- judge_score: min 0.0, max 0.5, mean 0.265

From `~/.cache/fastdistill/artifacts/openrouter_wikisql_1k_teacher_2026-01-26_v2/reports/student_eval_post_eval/quality_report.json`:
- total: 1000
