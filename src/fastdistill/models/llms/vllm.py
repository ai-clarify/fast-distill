...
class vLLM(LLM, MagpieChatTemplateMixin, CudaDevicePlacementMixin):
    ...
    def load(self) -> None:
        ...
        try:
            ...
            raise ImportError(
                "vLLM is not installed. Please install it using `pip install 'fastdistill[vllm]'`."
            ) from ie
...
class ClientvLLM(OpenAILLM, MagpieChatTemplateMixin):
    ...
    Examples:
        ...
        ```python
        from fastdistill.models.llms import ClientvLLM
    ...
    def load(self) -> None:
        ...
        try:
            ...
            raise ImportError(
                ...
                " `pip install 'fastdistill[openai]'`."
            ) from ie
        ...
        try:
            ...
            raise ImportError(
                ...
                "Please install it using `pip install 'fastdistill[hf-transformers]'`."
            ) from ie
