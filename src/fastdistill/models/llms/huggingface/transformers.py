...
from fastdistill.models.llms.utils import compute_tokens, prepare_output
...
from fastdistill.utils.huggingface import HF_TOKEN_ENV_VAR
...
if TYPE_CHECKING:
    ...
    from fastdistill.typing import HiddenState
...
class TransformersLLM(LLM, MagpieChatTemplateMixin, CudaDevicePlacementMixin):
    ...
    Examples:
        ...
        ```python
        from fastdistill.models.llms import TransformersLLM
    ...
    def load(self) -> None:
        ...
        try:
            ...
            raise ImportError(
                "Transformers is not installed. Please install it using `pip install 'fastdistill[hf-transformers]'`."
            ) from ie
