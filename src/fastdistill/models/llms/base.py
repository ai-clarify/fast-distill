...
from fastdistill.errors import FastDistillNotImplementedError, FastDistillUserError
...
class LLM(RuntimeParametersModelMixin, BaseModel, _Serializable, ABC):
    """Base class for `LLM`s to be used in `fastdistill` framework.
    ...
    def load(self) -> None:
        ...
        self._logger = logging.getLogger(f"fastdistill.llm.{self.model_name}")
    ...
    def generate_outputs(
        ...
        **kwargs: Any,
        ...
        if self.use_offline_batch_generation:
            ...
            # This will raise `FastDistillOfflineBatchGenerationNotFinishedException` right away
    ...
    def _offline_batch_generate_polling(
        ...
        **kwargs: Any,
        ...
        while True:
            ...
            except FastDistillOfflineBatchGenerationNotFinishedException as e:
                self._logger.info(
    ...
    def get_last_hidden_states(
        ...
        """
        # TODO: update to use `FastDistillNotImplementedError`
    ...
    def offline_batch_generate(
        ...
        **kwargs: Any,
        ...
        should raise a `FastDistillOfflineBatchGenerationNotFinishedException`. This exception
        ...
        Returns:
            A list containing the generations for each input.
        """
        raise FastDistillNotImplementedError(
...
class AsyncLLM(LLM):
    ...
    def _prepare_structured_output(  # type: ignore
        ...
        """
        from fastdistill.steps.tasks.structured_outputs.instructor import (
            prepare_instructor,
        )
    ...
    def _prepare_kwargs(
        ...
        if not (inspect.isclass(schema) and issubclass(schema, BaseModel)):
            from fastdistill.steps.tasks.structured_outputs.utils import (
