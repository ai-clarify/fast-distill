...
from fastdistill.constants import LAST_BATCH_SENT_FLAG
from fastdistill.errors import FASTDISTILL_DOCS_URL
...
from fastdistill.steps.base import GeneratorStep, Step, _Step
from fastdistill.typing import StepLoadStatus
            ...
            try:
                ...
                if self.step.is_global:
                    ...
                    data = (
                        batch.data
                        if isinstance(
                            e, FastDistillOfflineBatchGenerationNotFinishedException
                        )
                        else None
                    )
...
class _StepWrapperException(Exception):
    ...
    def __init__(
        ...
        self.message = f"{message}\n\nFor further information visit '{FASTDISTILL_DOCS_URL}api/pipeline/step_wrapper'"
        self.step = step
        self.code = code
