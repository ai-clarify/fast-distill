...
if TYPE_CHECKING:
    from fastdistill.utils.serialization import StrOrPath
...
class _BatchManagerStep(_Serializable):
    ...
    def from_step(
        ...
        return cls(
            ...
            data={predecessor: [] for predecessor in predecessors},  # noqa: C420
    ...
    def _get_data_for_convergence_step(
        ...
        remaining_rows_per_step: Dict[str, int] = dict.fromkeys(  # type: ignore[arg-type]
            self.data,
            self.input_batch_size,  # type: ignore[arg-type]
        )
