...
??? info "Category Overview" 
    ...
    | :material-brain:           | LLMs       | Explore all available Large Language Models integrated with fastdistill. |
    | :material-vector-line:     | Embeddings | Explore all available Embeddings Models integrated with fastdistill.    |
...
-   :material-brain:{ .lg .middle } __LLMs__
    ...
    Explore all the available `LLM`s integrated with `fastdistill`.
...
-   :material-image:{ .lg .middle } __ImageGenerationModels__
    ...
    Explore all the available `ImageGenerationModels`s integrated with `fastdistill`.
...
-   :material-vector-line:{ .lg .middle } __Embeddings__
    ...
    Explore all the available `Embeddings` models integrated with `fastdistill`.
