...
FASTDISTILL_FILENAME = "fastdistill-file.json"
...
_OLD_IMPORT_MODULE_ATTR: Dict[Tuple[str, str], Tuple[str, str]] = {
    ("fastdistill.pipeline.base", "_Batch"): ("fastdistill.pipeline.batch", "_Batch"),
    ("fastdistill.pipeline.base", "_BatchManager"): (
        "fastdistill.pipeline.batch_manager",
        "_BatchManager",
    ),
    ("fastdistill.pipeline.base", "_BatchManagerStep"): (
        "fastdistill.pipeline.batch_manager",
        "_BatchManagerStep",
    ),
}
