...
class LoadDataFromHub(GeneratorStep):
    ...
    def load(self) -> None:
        ...
        if self._dataset is not None:
            # Here to simplify the functionality of fastdistill.steps.generators.util.make_generator_step
            return
...
class LoadDataFromFileSystem(LoadDataFromHub):
    ...
    Examples:
        ...
        ```python
        from fastdistill.steps import LoadDataFromFileSystem
...
class LoadDataFromDisk(LoadDataFromHub):
    ...
    Examples:
        ...
        ```python
        from fastdistill.steps import LoadDataFromDisk
        ...
        Load data from a fastdistill Distiset:
