...
if TYPE_CHECKING:
    from fastdistill.steps.base import GeneratorStepOutput
...
class DataSampler(GeneratorStep):
    ...
    Examples:
        ...
        ```python
        from fastdistill.steps import DataSampler
        ...
        from fastdistill.steps import LoadDataFromDicts, DataSampler
        from fastdistill.steps.tasks.apigen.utils import PrepareExamples
