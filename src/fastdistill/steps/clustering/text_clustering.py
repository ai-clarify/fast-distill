...
from fastdistill.steps import StepInput
from fastdistill.steps.tasks import TextClassification
from fastdistill.steps.tasks.base import GlobalTask
...
class TextClustering(TextClassification, GlobalTask):
    ...
    Examples:
        ...
        from fastdistill.steps import UMAP, DBSCAN, TextClustering
