...
from fastdistill.steps.tasks.text_generation import (
    TextGeneration,
    check_column_in_template,
)
from fastdistill.utils.image import image_to_str

if TYPE_CHECKING:
    from PIL.Image import Image

    from fastdistill.typing import ChatType, StepColumns
...
class TextGenerationWithImage(TextGeneration):
    ...
    Examples:
        ...
        ```python
        from fastdistill.steps.tasks import TextGenerationWithImage
        ...
        #         ... # fastdistill_metadata would be here
        #     }
        # ]
        # result[0]["generation"]
