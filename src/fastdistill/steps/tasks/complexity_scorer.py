...
class ComplexityScorer(Task):
    ...
    Examples:
        ...
        ```python
        from fastdistill.steps.tasks import ComplexityScorer
        ...
        # result
        # [{'instructions': ['plain instruction', 'highly complex instruction'], 'model_name': 'test', 'scores': [1, 5], 'fastdistill_metadata': {'raw_output_complexity_scorer_0': 'output'}}]
        ```
        ...
        # result
        # [{'instructions': ['plain instruction', 'highly complex instruction'], 'model_name': 'test', 'scores': [1, 2], 'fastdistill_metadata': {'raw_output_complexity_scorer_0': '{ \\n  "scores": [\\n    1, \\n    2\\n  ]\\n}'}}]
        ```
