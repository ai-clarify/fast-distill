...
class ImageGeneration(ImageTask):
    ...
    It works with any of the `image_generation` defined under `fastdistill.models.image_generation`,
    ...
    `Distiset.transform_columns_to_image`. Take a look at the `Image Generation with fastdistill`
