...
from fastdistill.steps.tasks.evol_instruct.utils import MUTATION_TEMPLATES
from fastdistill.typing import ChatType
from fastdistill.utils.lists import flatten_responses

if TYPE_CHECKING:
    from fastdistill.typing import LLMStatistics, StepOutput
...
class EvolInstruct(Task):
    ...
    Examples:
        ...
        ```python
        from fastdistill.steps.tasks import EvolInstruct
