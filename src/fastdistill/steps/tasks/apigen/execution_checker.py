...
class APIGenExecutionChecker(Step):
    ...
    Examples:
        ...
        ```python
        from fastdistill.steps.tasks import APIGenExecutionChecker

        # For the libpath you can use as an example the file at the tests folder:
        # ../fastdistill/tests/unit/steps/tasks/apigen/_sample_module.py
        task = APIGenExecutionChecker(
            libpath="../fastdistill/tests/unit/steps/tasks/apigen/_sample_module.py",
        )
        task.load()
