...
from fastdistill.typing import FormattedInput

if TYPE_CHECKING:
    from fastdistill.typing import StepColumns
...
def _parse_docstring(docstring: str) -> Tuple[str, str]:
    ...
    Raises:
        FastDistillUserError: if the docstring doesn't follow the expected format or if
    ...
    try:
        ...
        raise FastDistillUserError(_DOCSTRING_FORMATTING_FUNCTION_ERROR, page="") from e
...
def _validate_templates(
    ...
    Raises:
        FastDistillUserError: if the system prompt or the user message template contain
